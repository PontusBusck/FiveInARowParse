...
public class VirtualGoodData {
	...
	////
		...
		public static String getVirtualGoodSortField(LiFieldVirtualGood field)
		{
			return field.toString();
		}
	public Object getVirtualGoodFieldbySortType(LiFieldVirtualGood field)
	{
		switch (field){
	...
	protected boolean setVirtualGoodFieldbySortType(LiFieldVirtualGood field, Object value)
	{
		switch (field){
			case VirtualGood_None:
				break;
