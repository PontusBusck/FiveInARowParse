...
public class VirtualGoodCategoryData {
	...
	////
		...
		public static String getVirtualGoodCategorySortField(LiFieldVirtualGoodCategory field)
		{
			return field.toString();
		}
	public Object getVirtualGoodCategoryFieldbySortType(LiFieldVirtualGoodCategory field)
	{
		switch (field){
	...
	protected boolean setVirtualGoodCategoryFieldbySortType(LiFieldVirtualGoodCategory field, Object value)
	{
		switch (field){
			case VirtualGoodCategory_None:
				break;
