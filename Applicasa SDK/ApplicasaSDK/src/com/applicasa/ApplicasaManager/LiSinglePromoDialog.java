...
import com.applicasa.Appia.LiAppiaManager;
import com.applicasa.ThirdParty.ThirdPartyManager;
import com.applicasa.Aarki.LiAarkiManager;
...
public class LiSinglePromoDialog extends Dialog   {
    ...
    public void loadPromotion() {
    	...
    	case CHARTBOOST:
    		...
    		break;
		case AARKI:
			LiAarkiManager.getInstance().show(mActivity, mSinglePromo, mLiPromotionResultCallback);
		break;
		case APPIA:
			LiAppiaManager.getInstance().show(mActivity, mSinglePromo, mLiPromotionResultCallback);
		break;
...
//				 = new BitmapDrawable(bitmap);
    ...
    private void LoadTrialPayPromo() {
		 ...
		 if (!ThirdPartyManager.validatePermissions(mSinglePromo , mActivity))
		{
			mLiPromotionResultCallback.onPromotionResultCallback(LiPromotionAction.Failed, LiPromotionResult.PromotionResultTrialPay, "Missing Activity/permission declartion in manifest file");
			return;
		}
